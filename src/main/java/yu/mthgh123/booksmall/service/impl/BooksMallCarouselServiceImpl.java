...
@Service
public class BooksMallCarouselServiceImpl implements BooksMallCarouselService {
    ...
    @Override
    public List<BooksMallIndexCarouselVO> getCarouselsForIndex(int number) {
        List<BooksMallIndexCarouselVO> booksMallIndexCarouselVOS = new ArrayList<>(number);
        List<Carousel> carousels = carouselMapper.findCarouselsByNum(number);
        if (!CollectionUtils.isEmpty(carousels)) {
            booksMallIndexCarouselVOS = BeanUtil.copyList(carousels, BooksMallIndexCarouselVO.class);
        }
        return booksMallIndexCarouselVOS;
    }
}
